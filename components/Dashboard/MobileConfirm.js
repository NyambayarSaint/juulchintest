...
const MobileConfirm = () => {
    ...
    return (
        <Container>
            <form className="pl-max pt-34">
                <div className="top">
                    <h4 className="title"><FaMobile /> Утасны дугаар баталгаажуулах</h4>
                </div>
                <div className="row">
                    ...
                    <div className="col-md-4 align-end">                    
                        <button onClick={handle} className="mt-40 primaryButton">СМС код илгээх</button>
                    </div>
                </div>
            </form>            
        </Container>
