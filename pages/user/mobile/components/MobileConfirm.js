...
const MobileConfirm = () => {
    ...
    return (
        <Container>
            <button className="button">Утасны дугаар баталгаажуулах</button>
            <form className="row">                
                <div className="col-md-12">                
                    <label className="smallTitle">Дугаар оруулах*</label>
                    <input className="formNumber" name="lastname" maxLength="10" ref={register({ required: true })} type="text" />    
                </div>
                <div className="col-md-12">                    
                    <button onClick={handle} className="mt-30 button">СМС код илгээх</button>
                </div>
            </form>            
        </Container>
    );
